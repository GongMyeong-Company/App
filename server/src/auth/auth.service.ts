...
export class AuthService {
    ...
    private async getTokens (patload: {email: string}){
        const [accessToken, refreshToken] = await Promise.all([
            this.jwtService.signAsync(patload, {
    ...
    async updateCategory(categories: Record<keyof MarkerColor, string>, user: User){
